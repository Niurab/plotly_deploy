...
function buildMetadata(sample) {
  d3.json("samples.json").then((data) => {
    ...
    // Use `Object.entry` to add each key and value pair to the panel
...
// Bar and Bubble charts
    ...
    // Deliverable 3
    // step: 1-3initialize variables that hold arrays for the sample selected from the dropdown menu on the webpage
    var metadata = data.metadata;
